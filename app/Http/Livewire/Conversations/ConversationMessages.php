...
class ConversationMessages extends Component
{
    ...
    public function getListeners(){
        return [
            ...
            "echo-private:conversations.{$this->conversationId},Conversations\\MessageAdded" => 'prependMesssageFromBroadcast'
        ];
    }
    ...
    public function prependMesssageFromBroadcast($payload){
